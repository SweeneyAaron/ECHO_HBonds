...
class SiteMapFactoryConfig:
    ...
    # Native grid kernels use OpenMP when the compiled extension supports it.
    workers: int = 1
...
class SiteMapFactory:
    ...
    def __init__(self, config: Optional[SiteMapFactoryConfig] = None):
        ...
        validate_workers(self.config.workers)
    ...
    def build(
        ...
        *,
        ...
        with grid_worker_context(self.config.workers):
            # 1) SASA masks
